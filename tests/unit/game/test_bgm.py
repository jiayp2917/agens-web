...
def test_resolve_track_prefers_project_root_bgm():
    ...
    # BGM file now lives in mobile/assets/audio/
    assert _resolve_track("default") == ROOT / "mobile" / "assets" / "audio" / "bgm.flac"
...
def test_audio_manager_play_bgm_alias_routes_through_service(monkeypatch):
    ...
    # Import from mobile.audio_manager (mobile package)
