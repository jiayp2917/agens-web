...
当前项目边界、冗余清理结论、USB 真机验证入口和后续技术债队列见 [docs/PROJECT_AUDIT.md](docs/PROJECT_AUDIT.md)。
...
后续智能体先读 [docs/INDEX.md](docs/INDEX.md)。项目边界和技术债见 [docs/PROJECT_AUDIT.md](docs/PROJECT_AUDIT.md)。
